"""date field schema changed

Revision ID: 9fb386d570fc
Revises: f4d39d92ac28
Create Date: 2023-12-22 09:36:58.634816
...
revision: str = '9fb386d570fc'
down_revision: Union[str, None] = 'f4d39d92ac28'
...
def downgrade() -> None:
    ...
    sa.Column('department', postgresql.ENUM('HR', 'IT', 'Finance', 'Operations', name='department_enum'), autoincrement=False, nullable=True),
